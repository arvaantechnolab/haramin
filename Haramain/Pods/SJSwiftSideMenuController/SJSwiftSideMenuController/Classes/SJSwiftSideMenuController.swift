...
public class SJSwiftSideMenuController: UIViewController, UINavigationControllerDelegate {
    ...
    func setUpContainers() {
        ...
        SJSwiftSideMenuController.containerView.backgroundColor = UIColor.black
        ...
        if SJSwiftSideMenuController.leftSideMenuController != nil {
            ...
            SJSwiftSideMenuController.leftSideMenuView.backgroundColor = UIColor.black
        ...
        if SJSwiftSideMenuController.rightSideMenuController != nil {
            ...
            SJSwiftSideMenuController.rightSideMenuView.backgroundColor = UIColor.black
