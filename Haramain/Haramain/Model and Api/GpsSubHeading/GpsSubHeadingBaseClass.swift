...
public final class GpsSubHeadingBaseClass: NSCoding {
  ...
  public var data: [GpsSubHeadingData]?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.data].array { data = items.map { GpsSubHeadingData(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? [GpsSubHeadingData]
