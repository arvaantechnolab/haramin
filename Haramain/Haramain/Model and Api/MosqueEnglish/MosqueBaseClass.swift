...
public final class MosqueBaseClass: NSCoding {
  ...
  public required init(json: JSON) {
    ...
    data = MosqueData(json: json[SerializationKeys.data])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? MosqueData
