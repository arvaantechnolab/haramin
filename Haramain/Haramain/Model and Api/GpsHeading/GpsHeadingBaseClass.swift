...
public final class GpsHeadingBaseClass: NSCoding {
  ...
  public var data: [GpsHeadingData]?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.data].array { data = items.map { GpsHeadingData(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? [GpsHeadingData]
