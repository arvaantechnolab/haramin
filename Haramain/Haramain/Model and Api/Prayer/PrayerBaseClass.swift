...
public final class PrayerBaseClass: NSCoding {
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.data].array { data = items.map { PrayerData(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? [PrayerData]
