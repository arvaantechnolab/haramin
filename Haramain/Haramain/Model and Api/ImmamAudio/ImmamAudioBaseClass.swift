...
public final class ImmamAudioBaseClass: NSCoding {
  ...
  public var data: [ImmamAudioData]?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.data].array { data = items.map { ImmamAudioData(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? [ImmamAudioData]
