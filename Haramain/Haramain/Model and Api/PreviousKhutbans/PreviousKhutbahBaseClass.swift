//
//  PreviousKhutbahBaseClass.swift
//
...
public final class PreviousKhutbahBaseClass: NSCoding {
  ...
  public var data: [PreviousKhutbahData]?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.data].array { data = items.map { PreviousKhutbahData(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? [PreviousKhutbahData]
